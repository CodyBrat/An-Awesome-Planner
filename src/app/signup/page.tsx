...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // For demo purposes, just redirect to demo page
      router.push('/demo');
    } catch (err) {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-background-light py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center">
              <input
                ...
                type="checkbox"
                required
                className="h-4 w-4 border-gray-700 rounded bg-background-lighter text-primary focus:ring-primary"
              />
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <div>
                <a
                  href="#"
                  className="w-full inline-flex justify-center py-2 px-4 border border-gray-700 rounded-md shadow-sm bg-background-lighter text-sm font-medium text-gray-300 hover:bg-background-light"
                >
